...
interface OpenSearchDashboardsClient {
  ...
  indices: {
    ...
    existsType<TContext = unknown>(
      params: T.IndicesExistsTypeRequest,
      options?: TransportRequestOptions
    ): TransportRequestPromise<ApiResponse<T.IndicesExistsTypeResponse, TContext>>;
    ...
    flushSynced<TContext = unknown>(
      params?: T.IndicesFlushSyncedRequest,
      options?: TransportRequestOptions
    ): TransportRequestPromise<ApiResponse<T.IndicesFlushSyncedResponse, TContext>>;
